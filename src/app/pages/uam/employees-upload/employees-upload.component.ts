...
import { EmployeesUploadService } from 'src/app/shared/services/uam/employees-upload.service';
import { EmployeesUploadModel } from 'src/app/shared/models/employees-upload.model';
import { validateWhiteSpace } from 'src/app/shared/validations/validation';
import { DownloadAttachmentModel } from 'src/app/shared/models';
import * as saveAs from 'file-saver';
import { environment } from 'src/environments/environment';


@Component({
  selector: 'app-employees-upload',
  templateUrl: './employees-upload.component.html',
  styleUrls: ['./employees-upload.component.css'],
})
export class EmployeesUploadComponent
  extends BaseDetailComponent<EmployeesUploadModel>
  implements OnInit
{
  properties: any = {
  ...
  constructor(
    ...
    private employeesuploadService: EmployeesUploadService,
  ...
  fileChange(event: {
    ...
    if (fileList.length > 0) {
      ...
      if (upld == 'csv') {
        ...
        this.employeesuploadService.uploadFile(formData).subscribe((fileName: any) => {
  ...
  rolePostData() {
        ...
        this.employeesuploadService.addData(this.filenameData).subscribe((resp: any) => {
